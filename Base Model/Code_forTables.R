...
# Code to create table 2 (and appendix tables) in fentanyl paper- this prints the necessary non-PSA data
# For 1yr, 5yr, 10yr outputs.
#   Code written as a funtion, you plug in timeperiod, fentanyl policy, and intervention presence data.
...
fentanyl_deaths <- function(years, atRisk, diversionProgram, MOUD_Jail1) {
...
1-exp(-(-log(1-(as.numeric(CDC_deaths[which(CDC_deaths$State2==State),"DEATHS"])/N_pop1)))/12) #0.0008981294 for CO
...
Results_5yr_4g_nointerv <- fentanyl_deaths(years=5, atRisk="1", diversionProgram=0, MOUD_Jail1=0)
Results_5yr_1g_nointerv <- fentanyl_deaths(years=5, atRisk="2", diversionProgram=0, MOUD_Jail1=0)
Results_5yr_Any_nointerv <- fentanyl_deaths(years=5, atRisk="3", diversionProgram=0, MOUD_Jail1=0)

Results_5yr_4g_MOUD <- fentanyl_deaths(years=5, atRisk="1", diversionProgram=0, MOUD_Jail1=1)
Results_5yr_1g_MOUD <- fentanyl_deaths(years=5, atRisk="2", diversionProgram=0, MOUD_Jail1=1)
Results_5yr_Any_MOUD <- fentanyl_deaths(years=5, atRisk="3", diversionProgram=0, MOUD_Jail1=1)

Results_5yr_4g_Diversion <- fentanyl_deaths(years=5, atRisk="1", diversionProgram=1, MOUD_Jail1=0)
Results_5yr_1g_Diversion <- fentanyl_deaths(years=5, atRisk="2", diversionProgram=1, MOUD_Jail1=0)
Results_5yr_Any_Diversion <- fentanyl_deaths(years=5, atRisk="3", diversionProgram=1, MOUD_Jail1=0)

Results_5yr_4g_MOUD_Diversion <- fentanyl_deaths(years=5, atRisk="1", diversionProgram=1, MOUD_Jail1=1)
Results_5yr_1g_MOUD_Diversion <- fentanyl_deaths(years=5, atRisk="2", diversionProgram=1, MOUD_Jail1=1)
Results_5yr_Any_MOUD_Diversion <- fentanyl_deaths(years=5, atRisk="3", diversionProgram=1, MOUD_Jail1=1)

Results <- rbind(Results_5yr_4g_nointerv,Results_5yr_1g_nointerv,Results_5yr_Any_nointerv,
                     Results_5yr_4g_MOUD,Results_5yr_1g_MOUD,Results_5yr_Any_MOUD,
                     Results_5yr_4g_Diversion,Results_5yr_1g_Diversion,Results_5yr_Any_Diversion,
                     Results_5yr_4g_MOUD_Diversion,Results_5yr_1g_MOUD_Diversion,Results_5yr_Any_MOUD_Diversion)

Results$Incarcerated <- Results$Arrested+ Results$Released_immediate + Results$Released_post1yr + Results$Released_1yr

Results2 <- Results[,c(11,13,16:20)]

write.csv(Results2,file="Results_5yr.csv")

# 10yr

Results_10yr_4g_nointerv <- fentanyl_deaths(years=10, atRisk="1", diversionProgram=0, MOUD_Jail1=0)
Results_10yr_1g_nointerv <- fentanyl_deaths(years=10, atRisk="2", diversionProgram=0, MOUD_Jail1=0)
Results_10yr_Any_nointerv <- fentanyl_deaths(years=10, atRisk="3", diversionProgram=0, MOUD_Jail1=0)

Results_10yr_4g_MOUD <- fentanyl_deaths(years=10, atRisk="1", diversionProgram=0, MOUD_Jail1=1)
Results_10yr_1g_MOUD <- fentanyl_deaths(years=10, atRisk="2", diversionProgram=0, MOUD_Jail1=1)
Results_10yr_Any_MOUD <- fentanyl_deaths(years=10, atRisk="3", diversionProgram=0, MOUD_Jail1=1)

Results_10yr_4g_Diversion <- fentanyl_deaths(years=10, atRisk="1", diversionProgram=1, MOUD_Jail1=0)
Results_10yr_1g_Diversion <- fentanyl_deaths(years=10, atRisk="2", diversionProgram=1, MOUD_Jail1=0)
Results_10yr_Any_Diversion <- fentanyl_deaths(years=10, atRisk="3", diversionProgram=1, MOUD_Jail1=0)

Results_10yr_4g_MOUD_Diversion <- fentanyl_deaths(years=10, atRisk="1", diversionProgram=1, MOUD_Jail1=1)
Results_10yr_1g_MOUD_Diversion <- fentanyl_deaths(years=10, atRisk="2", diversionProgram=1, MOUD_Jail1=1)
Results_10yr_Any_MOUD_Diversion <- fentanyl_deaths(years=10, atRisk="3", diversionProgram=1, MOUD_Jail1=1)

Results <- rbind(Results_10yr_4g_nointerv,Results_10yr_1g_nointerv,Results_10yr_Any_nointerv,
                 Results_10yr_4g_MOUD,Results_10yr_1g_MOUD,Results_10yr_Any_MOUD,
                 Results_10yr_4g_Diversion,Results_10yr_1g_Diversion,Results_10yr_Any_Diversion,
                 Results_10yr_4g_MOUD_Diversion,Results_10yr_1g_MOUD_Diversion,Results_10yr_Any_MOUD_Diversion)

Results$Incarcerated <- Results$Arrested+ Results$Released_immediate + Results$Released_post1yr + Results$Released_1yr

Results2 <- Results[,c(11,13,16:20)]

write.csv(Results2,file="Results_10yr.csv")

# 1yr

Results_1yr_4g_nointerv <- fentanyl_deaths(years=1, atRisk="1", diversionProgram=0, MOUD_Jail1=0)
Results_1yr_1g_nointerv <- fentanyl_deaths(years=1, atRisk="2", diversionProgram=0, MOUD_Jail1=0)
Results_1yr_Any_nointerv <- fentanyl_deaths(years=1, atRisk="3", diversionProgram=0, MOUD_Jail1=0)

Results_1yr_4g_MOUD <- fentanyl_deaths(years=1, atRisk="1", diversionProgram=0, MOUD_Jail1=1)
Results_1yr_1g_MOUD <- fentanyl_deaths(years=1, atRisk="2", diversionProgram=0, MOUD_Jail1=1)
Results_1yr_Any_MOUD <- fentanyl_deaths(years=1, atRisk="3", diversionProgram=0, MOUD_Jail1=1)

Results_1yr_4g_Diversion <- fentanyl_deaths(years=1, atRisk="1", diversionProgram=1, MOUD_Jail1=0)
Results_1yr_1g_Diversion <- fentanyl_deaths(years=1, atRisk="2", diversionProgram=1, MOUD_Jail1=0)
Results_1yr_Any_Diversion <- fentanyl_deaths(years=1, atRisk="3", diversionProgram=1, MOUD_Jail1=0)

Results_1yr_4g_MOUD_Diversion <- fentanyl_deaths(years=1, atRisk="1", diversionProgram=1, MOUD_Jail1=1)
Results_1yr_1g_MOUD_Diversion <- fentanyl_deaths(years=1, atRisk="2", diversionProgram=1, MOUD_Jail1=1)
Results_1yr_Any_MOUD_Diversion <- fentanyl_deaths(years=1, atRisk="3", diversionProgram=1, MOUD_Jail1=1)

Results <- rbind(Results_1yr_4g_nointerv,Results_1yr_1g_nointerv,Results_1yr_Any_nointerv,
                 Results_1yr_4g_MOUD,Results_1yr_1g_MOUD,Results_1yr_Any_MOUD,
                 Results_1yr_4g_Diversion,Results_1yr_1g_Diversion,Results_1yr_Any_Diversion,
                 Results_1yr_4g_MOUD_Diversion,Results_1yr_1g_MOUD_Diversion,Results_1yr_Any_MOUD_Diversion)

Results$Incarcerated <- Results$Arrested+ Results$Released_immediate + Results$Released_post1yr+ Results$Released_1yr

Results2 <- Results[,c(11,13,16:20)]

write.csv(Results2,file="Results_1yr.csv")
